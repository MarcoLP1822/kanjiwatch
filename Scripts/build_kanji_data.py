...
ATTRIBUTION = """\
This app includes data derived from three sources.

• KanjiVG — stroke paths and stroke types
  © Ulrich Apel — https://kanjivg.tagaini.net
  Licence: Creative Commons Attribution-ShareAlike 3.0
  https://creativecommons.org/licenses/by-sa/3.0/

• KANJIDIC2 — readings, meanings and school grades
  © Electronic Dictionary Research and Development Group (EDRDG)
  https://www.edrdg.org/wiki/index.php/KANJIDIC_Project

• JMdict — the example word and its reading
  © Electronic Dictionary Research and Development Group (EDRDG)
  https://www.edrdg.org/wiki/index.php/JMdict-EDICT_Dictionary_Project

The KANJIDIC2 and JMdict files are the property of the Electronic Dictionary Research
...
The bundled kanji data is a derivative work of the sources above and is distributed
under the same licences. It is regenerated from the most recent upstream versions at
every release of the app (Scripts/update_data.sh).
"""
